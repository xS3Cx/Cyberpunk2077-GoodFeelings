-- View/World/Facts/RomanceFlagsView.lua
local UI = require("UI")
...
local function RomanceFlagsViewFunction()
    local entries = GameFacts.FactFlags.RomanceFlags
