-- View/World/Facts/StoryOutcomesView.lua
local UI = require("UI")
...
local function StoryOutcomesViewFunction()
    local entries = GameFacts.FactFlags.StoryOutcomeFlags
...
return {
    ...
    view = StoryOutcomesViewFunction
}
