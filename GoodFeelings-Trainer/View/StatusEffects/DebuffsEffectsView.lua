...
local function StatusEffectDebuffsView()
    local effects = StatusEffectLoader:GetCategory("Debuffs")
    local current = StatusEffectBrowser.GetCurrentEffect()
    
    Buttons.Break("Debuff Effects (" .. #effects .. ")")
...
return { title = "Debuff Effects", view = StatusEffectDebuffsView }
