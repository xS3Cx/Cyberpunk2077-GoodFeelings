...
local function StatusEffectQuickhacksView()
    local effects = StatusEffectLoader:GetCategory("Quickhacks")
    local current = StatusEffectBrowser.GetCurrentEffect()
    
    Buttons.Break("Quickhack Effects (" .. #effects .. ")")
...
return { title = "Quickhack Effects", view = StatusEffectQuickhacksView }
